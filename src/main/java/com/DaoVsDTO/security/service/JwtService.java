...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        return Jwts.builder()
                ...
                .signWith(getSigningKey(), SignatureAlgorithm.HS256) // Firma con la nueva clave
                .compact();
    }
    ...
    /**
     * Extrae todos los claims del token usando la sintaxis moderna.
     */
    ...
    /**
     * Obtiene la clave de firma a partir de la secretKey en formato Base64.
     */
